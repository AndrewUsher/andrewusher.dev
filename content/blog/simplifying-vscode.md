...
- [codecrumbs-vs-code](https://marketplace.visualstudio.com/items?itemName=codecrumbs.codecrumbs-vs-code) - Never used it after the first few weeks of installing
- [Codetour](https://marketplace.visualstudio.com/items?itemName=vsls-contrib.codetour) - Same as above
- [Import Cost](https://marketplace.visualstudio.com/items?itemName=wix.vscode-import-cost) - I use Bundlephobia for this instead
- [Playwright Test for VSCode](https://marketplace.visualstudio.com/items?itemName=ms-playwright.playwright) - I use [Playwright's UI mode](https://playwright.dev/docs/test-ui-mode) for this functionality now
- [Polacode](https://marketplace.visualstudio.com/items?itemName=pnp.polacode) - I use [ray.so](https://ray.so/) instead now
- [ReacTree](https://marketplace.visualstudio.com/items?itemName=ReacTreeDev.reactree) - Seemed cool when I looked at it, but I've never had a use case for it
- [Remove Non ASCII Chars](https://marketplace.visualstudio.com/items?itemName=SamuelCharpentier.remove-non-ascii-chars) - The linting tools I use already handles this
