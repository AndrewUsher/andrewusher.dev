...
export function Footer () {
  return (
    <footer className="text-gray-500 bg-gray-50 dark:text-slate-300 dark:bg-neutral-700">
      <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          <nav className="grid grid-cols-2 gap-4 text-center sm:grid-cols-3 lg:grid-cols-6">
            <Link to="/about" className="hover:opacity-75">About Me</Link>
          ...
          <div className="flex justify-center mt-8 space-x-6">
            <a href="https://twitter.com/AndrewUsher17" target="_blank" rel="noreferrer" aria-label="Twitter" className="hover:opacity-75">
            ...
            <a href="https://github.com/AndrewUsher" target="_blank" rel="noreferrer" aria-label="GitHub" className="hover:opacity-75">
              <svg fill="currentColor" viewBox="0 0 24 24" aria-hidden="true" className="w-6 h-6">
                <path
                  fillRule="evenodd"
