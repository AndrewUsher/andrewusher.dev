  ...
  return (
    <div className="dark:bg-neutral-900 dark:border-neutral-700 my-8 rounded-lg border border-slate-200 bg-white p-6 shadow-lg">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <div>
          <div className="mb-4">
            <div className="dark:text-slate-300 mb-2 text-sm font-medium text-slate-700">
              Interactive Architecture Diagram
            </div>
            <div className="dark:text-slate-400 text-xs text-slate-500">
              Add clients to see them connect. Click clients to remove them.
            </div>
          </div>

          <div
            className="dark:bg-neutral-800 dark:border-neutral-600 relative overflow-hidden rounded-lg border-2 border-dashed border-slate-300 bg-slate-50"
          ...
          >
            ...
            {/* Status overlay */}
            {clients.length === 0 && (
              <div className="dark:bg-neutral-800/80 absolute inset-0 flex items-center justify-center bg-slate-50/80">
                <div className="text-center">
                  <p className="dark:text-slate-400 font-medium text-slate-600">
          ...
          <div className="mt-4 grid grid-cols-3 gap-2 text-center">
            <div className="dark:bg-neutral-800 rounded bg-slate-100 p-2">
              <div className="dark:text-sky-400 text-2xl font-bold text-sky-600">
                {clients.length}
              </div>
            ...
            <div className="dark:bg-neutral-800 rounded bg-slate-100 p-2">
              <div className="dark:text-purple-400 text-2xl font-bold text-purple-600">
                {state.messageCount}
              </div>
              <div className="dark:text-slate-400 text-xs text-slate-600">
                Messages
            ...
            <div className="space-y-2">
              <div className="flex flex-wrap gap-2">
                <button
                  ...
                  className="rounded-lg bg-sky-500 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-sky-600 disabled:cursor-not-allowed disabled:bg-slate-300"
                >
                ...
                <button
                  ...
                  disabled={clients.length >= 6}
                  className="rounded-lg bg-emerald-500 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-emerald-600 disabled:cursor-not-allowed disabled:bg-slate-300"
                >
                  + Add SSE Client
                </button>
              </div>
              ...
              <div className="flex flex-wrap gap-2">
                <button
                  ...
                  className="rounded-lg bg-purple-500 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-purple-600 disabled:cursor-not-allowed disabled:bg-slate-300"
                >
                  Send Random Message
                </button>
                ...
                <button
                  ...
                  className="rounded-lg bg-indigo-500 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-indigo-600 disabled:cursor-not-allowed disabled:bg-slate-300"
                >
                  Broadcast to All
                </button>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  onClick={reset}
                  className="ml-auto rounded bg-red-500 px-3 py-1 text-sm text-white transition-colors hover:bg-red-600"
                >
                  Reset
                </button>
              </div>
